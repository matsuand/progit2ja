...
my $lines = "";
print $fh_tgt "%This is the change file for the original ProGit2's Documentation file.\n";
print $fh_tgt "%This is part of Japanese translation version for ProGit2's Documantation.\n";
